            ...
            <div id="con">
                <ul>
                    <?php foreach ($printer as $id => $row): ?>
                        <li>
                            <div class="qrcod">
                                <img src="<?php print $this->config->base_url(); ?>assets/img/qrcode/<?php print $row->for_id; ?>.png" alt="NO QR" />
                            </div>
                            <div class="cinfo">
                                <div class="route">
                                    <?php print $row->for_route; ?>
                                </div>
                                <div class="snumb">
                                    <?php print $row->for_street_number; ?>
                                </div>
                                <div class="sublo">
