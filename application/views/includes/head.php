...
<!-- Styles: Basic -->
<link rel="stylesheet" type="text/css" href="<?php print $this->config->base_url(); ?>browser/css/bower.css" />
<!-- Styles: Responsive -->
<style type="text/css">
    @import url("<?php print $this->config->base_url(); ?>browser/css/mode-sm.css") (max-width: 900px);
    @import url("<?php print $this->config->base_url(); ?>browser/css/mode-md.css") (min-width: 900px);
</style>
<!-- Scripts -->
